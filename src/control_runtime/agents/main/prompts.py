...
Return the GlobalControlIntent object with these fields:
session_id, snapshot_id, raw_input, supi, round_strategy, next_agent,
requested_domains, domain_evidence, control_semantics, objective_profile,
investigation_targets, uncertainty_flags, retry_scope, required_evidence,
forbidden_assumptions, intent_encoding_guidance, routing_decision,
routing_rationale, routing_confidence, reuse_contract, handoff_expectations.
"""
