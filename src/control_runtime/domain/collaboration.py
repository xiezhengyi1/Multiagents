...
class PlanningContext(BaseModel):
    ...
    main_routing_confidence: float = Field(default=0.0, description="Main confidence in its routing decision")
    main_reuse_contract: Dict[str, Any] = Field(default_factory=dict, description="Explicit reuse contract declared by Main")
    main_handoff_expectations: list[Dict[str, Any]] = Field(default_factory=list, description="Explicit handoff expectations declared by Main")
