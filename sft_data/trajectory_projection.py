...
from sft_data.schemas import ChatmlSftRecord, DatasetMessage, ProjectedTraceRecord, WorkflowTrajectoryRecord
...
def load_projected_trace_records_for_agent(project_root: Path, agent_name: str) -> List[ProjectedTraceRecord]:
    trace_path = project_root / "sft_data" / agent_name / "raw_traces" / f"{agent_name}.jsonl"
